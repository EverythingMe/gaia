...
(function(exports) {
  ...
  // TODO not sure what size to use.
  // size should be big enough for 3 (zoomed) and 4 column grid layout
  // @kgrandon?
  var size = 60;
  ...
  var sideIconDarken = 0.65;

  // app icons centering
  var vOffset = 13 * scale;
  var hOffset = 21 * scale;

  var xMain = center - dMain / 2;
  var yMain = height - (vOffset + dMain/2);

  var xLeft = center - hOffset - dSide / 2;
  var xRight = center + hOffset - dSide / 2;
  var ySide = height - (vOffset + dSide/2);

  // gradient stops: top to bottom
  var gradStops = ['rgba(0,0,0,0)', 'rgba(0,0,0,0.65)'];

  var defaultBgFill = 'rgba(51, 51, 51, 0.85)';
  var deafultBgImage = '/everything.me/images/collection_icon_default.png';
